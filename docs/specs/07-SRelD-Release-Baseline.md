...
**Baseline descrita:** v0.2.1 (texto 1.1 conservado); producto v0.2.7 / árbol v0.2.8  
...
## Evolución registrada hasta v0.2.7 / árbol v0.2.8

La baseline histórica v0.2.1 de este SRelD **no se reescribe**.

| Versión | Contenido principal |
|---------|---------------------|
| 0.2.2 | Poetry portable, ENVIRONMENTS, guard WSL `/mnt` |
| 0.2.3 | Poetry Git Bash, `.gitattributes` LF |
| 0.2.4 | update sincroniza tags |
| 0.2.5 | a11y, docs, synccheck, política A11Y CLI |
| 0.2.6 | Specs 08/09/10; comandos apps, tareas, hilos, iarouter |
| 0.2.7 | Apps reales (git, ámbitos, mini-moslib); worker de tareas; Jan, GPT4All, Grok, OpenRouter |
| 0.2.8 (árbol, tag pendiente) | iarouter modelos/clave/LAN/share/puente; secreto .mos; update reiniciar |

No regresión añadida tras 0.2.7: puerta SEC sobre comandos de app; iarouter off por defecto.

Comandos de sistema actuales además de los de v0.2.1: a11y, docs, synccheck, apps, tareas, hilos, iarouter, red, man.
