...
**Estado:** Normativo (texto 1.0 conservado; implementado en producto 0.2.7)  
**Baseline:** v0.2.5 (texto 1.0); producto v0.2.7  
**Documentos relacionados:** docs/specs/01-SSS-System-Specification.md, docs/specs/08-APPS.md, docs/A11Y.md, docs/INCENTIVOS.md, docs/plans/2026-09-01-02-campana-07-soporte-apps-tareas-ia.md, docs/man/tareas.md, docs/man/hilos.md
...
## Ampliación 1.1 (implementado)

El frente B de la 07 está en el árbol: `moslib.core.tasks`, comandos `tareas` y `hilos`, worker de sesión, `tests/test_tasks.py`.

Las automáticas de esta baseline siguen siendo **locales**. No es la malla P2P.

Campos y clases de 1.0 no se renombran.
