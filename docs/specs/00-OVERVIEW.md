...
**Baseline de referencia:** v0.2.4 (texto 1.4 conservado); producto v0.2.7 / árbol v0.2.8  
**Estado:** Normativo  
...
| docs/ | specs/ | 08-APPS.md | APPS | Paquetes de aplicación |
| docs/ | specs/ | 09-TASKS.md | TASKS | Tareas e hilos |
| docs/ | specs/ | 10-IA-ROUTER.md | IA | Fachada de modelos |
...
| docs/ | INCENTIVOS.md | Vectores de incentivo |
| docs/ | DEUDA_Y_CAMPANAS.md | Deuda y campañas |
| docs/ | INTERACTION_REVIEW.md | Revisión de interacción |
| docs/ | man/ | Páginas man por comando |
| docs/ | plans/ | Planes de campaña |
| apps/ | | Apps de producto versionadas |
...
4. `08-APPS`, `09-TASKS`, `10-IA-ROUTER` en su dominio
5. `05-SDD` (diseño)
6. Código fuente
7. `USER_MANUAL`, páginas `man`, README

Regla:

- El código debe cumplir SEC, SSS, ICD, SRS, A11Y y la spec de dominio afectada.
...
La seguridad tiene documento propio (`04-SEC`). La accesibilidad tiene política y declaración propias (`docs/A11Y.md`, `docs/a11y/`). Apps, tareas e IA son anexos de dominio.
...
2. Si toca apps, tareas o modelos, actualizar 08 / 09 / 10.
3. Si cambia arquitectura, actualizar SDD.
4. Implementar en rama `feature/...`.
5. Añadir o ajustar tests según 06-TEST y STYLE_GUIDE.
6. Actualizar manual/man/README/onboarding/CHANGELOG/declaración si afecta a uso, proceso, release o cumplimiento A11Y.
7. Merge solo con tests en verde.
8. Aplicar VERSIONING (bump/tag si es producto).
...
3. ¿Rompe el contrato de comando (ICD) o la prioridad de carga?
...
Producto de referencia del texto 1.4: **v0.2.4**.  
Producto Poetry / main: **v0.2.7**.  
Árbol hacia **v0.2.8** pendiente de pruebas humanas.
...
El conjunto ECSS-light incluye 08-APPS, 09-TASKS y 10-IA-ROUTER. Soporte: INCENTIVOS, DEUDA_Y_CAMPANAS, INTERACTION_REVIEW, apps/.
...
Cualquier alta, baja o renombrado de documentos del set ECSS-light (o de soporte como ENVIRONMENTS, VERSIONING, CHANGELOG, A11Y, INCENTIVOS, planes u onboarding) debe reflejarse aquí.
