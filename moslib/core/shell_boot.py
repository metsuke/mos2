...
from moslib.core.shell_boot_int import comprobar_integridad
...
def run_startup_tests() -> tuple:
    if not comprobar_integridad():
        return False, ""
    workers = _xdist()
    modo = f"{HILOS} hilos" if workers else "1 hilo"
